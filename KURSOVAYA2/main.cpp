...
int main() {
    ...
    while (true) {
        ...
        cout << "\t3. Поиск в отсортированной базе по ключу (по фио вкладчика)" << endl;
        cout << "\t4. Поиск в дереве (по сумме вклада)" << endl;
        ...
        switch (enter) {
            ...
            case 52:
                ...
                cout << "Посмотреть дерево (1 - да, любая другая кнопка - нет) ";
                cin >> x;
                if (x == 1) {
                    print_tree(root);
                }
...
void print_base(list *l) {
    ...
    int c = 0;
    cout << "1 - вывод по 20" << endl << "2 - вывод всего списка" << endl;
